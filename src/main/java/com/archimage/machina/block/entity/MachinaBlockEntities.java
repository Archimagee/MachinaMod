...
public class MachinaBlockEntities
{
    ...
    public static final RegistryObject<BlockEntityType<RockTumblerBlockEntity>> ROCK_TUMBLER_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("rock_tumbler_block_entity", () ->
                    BlockEntityType.Builder.of(RockTumblerBlockEntity::new, MachinaBlocks.ROCK_TUMBLER_BLOCK.get()).build(null));
